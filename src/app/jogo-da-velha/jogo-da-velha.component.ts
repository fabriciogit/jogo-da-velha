...
export class JogoDaVelhaComponent implements OnInit {
  ...
  /** Retorna se a tela deve ser exibida. 
   * 
   * @return boolean
   */
  get showInicio(): boolean{
    return this.jogoDaVelhaService.showIicio;
  }
   ...
   */
    ...
    /** Retorna se a marcação de vitória deve ser exibida para a coordanada informada. 
     * 
     * @param number posX
     * @param number posY
     * @return boolean
